...
public class main extends AppCompatActivity {
    ...
    // and profile image
    private static final String urlNavHeaderBg = "http://i42.tinypic.com/xmpg6g.jpg";
    private static final String urlProfileImg = "http://i40.tinypic.com/eqp1s9.jpg";

    // index to identify current nav menu item
    public static int navItemIndex = 0,prevnavItemIndex = 0;
    ...
    private void loadNavHeader() {
        // name, website
        txtName.setText("Name of person");
        txtWebsite.setText("email of person");
    ...
    /*private void selectNavMenu() {
        if(prevnavItemIndex!=navItemIndex){
        navigationView.getMenu().getItem(prevnavItemIndex).setChecked(false);}
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.upload){
            startActivity(new Intent(this,uploaderScreen.class));
        }
