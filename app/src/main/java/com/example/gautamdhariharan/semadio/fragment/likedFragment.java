...
public class likedFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        int height=sp.getScreenHeight(likedFragment.this.getActivity());
        int width=sp.getScreenWidth(likedFragment.this.getActivity());
        TextView tv;
        LinearLayout l;
        l=(LinearLayout)getActivity().findViewById(R.id.ll);
        for(int j=0;j<l.getChildCount();j++){
            tv=(TextView) l.getChildAt(j);
            tv.setWidth(width);
